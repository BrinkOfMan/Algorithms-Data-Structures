/*
Note for graders: don't count this! It's not my own code! This is from https://www.geeksforgeeks.org/longest-increasing-subsequence-dp-3/
I wanted to have *something* to time the longest-sub.cpp against, and I figure this will do
*/
